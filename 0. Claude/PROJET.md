...
0. ⏳ **OUVERT — Ajouter « prix sur demande » sur chaque page instrument** (soprano, alto, hautbois) — visible en desktop et mobile, à placer et styler selon Simeon.
1. ⏳ **OUVERT — Mettre à jour les titres des pages instrument** — ajouter « selon [facteur] » aux titres (ex. « Alto en FA selon… », « Soprano selon… »). Facteurs à confirmer avec Simeon pour chaque bois/instrument.
2. ⏳ **OUVERT — Ajouter un crédit/lien vers le site de Simeon** — ligne de crédit indiquant que Simeon a créé/codé cette page, avec un lien vers son portfolio/site web. Placer dans le footer ou une section dédiée selon Simeon.
